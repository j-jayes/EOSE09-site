...
author: Jonathan Jayes, updated by Nico Meffe
date: today
format:
  html:
    code-overflow: wrap
...
In the past Jonathan received a request to calculate and plot sigma-convergence for Sweden using Stata.  This page shows some information he shared with his students about sigma-convergence in relation to this course.
