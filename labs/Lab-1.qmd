...
author: Vinzent Ostermeyer, adapted Jonathan Jayes edited by Nico Meffe
date: 2026-02-09
format:
  html:
    code-overflow: wrap
...
In addition, your lab paper (📅 due March 13th) requires that you include at least 6 maps, so it is worth concentrating in the labs and making use of these resources.📝
...
![Try and make your comments more useful than these!](Lab-1-resources/commenting.PNG)
